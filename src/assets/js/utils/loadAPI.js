...
const configURL = "https://api.olimbosmc.it/battlylauncher/launcher/config-launcher/config.json";
const versionsURL = "https://api.olimbosmc.it/battlylauncher/launcher/config-launcher/versions.json";
